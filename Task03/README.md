...
Игра "Крестики-нолики" (tic-tac-toe) с компьютером на поле произвольного размера (от 3x3 до 10x10).
...
3. Выполнить команду `composer create-project dksenia/tic-tac-toe`;
...
Packagist: <https://packagist.org/packages/dksenia/tic-tac-toe>
