...
class StudentsListTest extends TestCase
{
    ...
    public function testGet()
    {
        $student = new Student();
        $studentsList = new StudentsList();
        $student -> setName("Ksenia") -> setLastName("Duraeva") -> setFaculty("FMiIT") -> setCourse(4) -> setGroup(402);
        $studentsList -> add($student);
    ...
    public function testCurrentAndKey()
    {
        ...
        $studentsList = new StudentsList();
        $student1 -> setName("Ksenia") -> setLastName("Duraeva") -> setFaculty("FMiIT")-> setCourse(4) -> setGroup(402);
        $student2 -> setName("Arina") -> setLastName("Oparina") -> setFaculty("UF") -> setCourse(1) -> setGroup(102);
        $student3 -> setName("Daria") -> setLastName("Kulyasova") -> setFaculty("EF") -> setCourse(3) -> setGroup(305);
